...
namespace FractionTests
{
    ...
    public class FractionTests
    {
        ...
        [TestMethod]
        public void TestGreaterOp()
        {
            DoTest(3, 4, 2, 3);
            DoTest(1, 1, 0, 1);
            DoTest(5, 2, -1, 8);

            void DoTest(long n1, long d1, long n2, long d2)
            {
                Assert.IsTrue(new Fraction(n1, d1) > new Fraction(n2, d2));
            }
        }
        ...
        public void TestPlusOp()
        {
            ...
            {
                var frac = new Fraction(n1, d1) + new Fraction(n2, d2);
                Assert.AreEqual(expectedN, frac.Numerator);
                Assert.AreEqual(expectedD, frac.Denominator);
            }
        }
