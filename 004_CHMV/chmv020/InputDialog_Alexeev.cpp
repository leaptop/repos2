...
InputDialog_Alexeev::InputDialog_Alexeev(QWidget* pwgt): QDialog(pwgt)
{
...
QString InputDialog_Alexeev::firstName() const
{
    return m_ptxtFirstName->text();
}
QString InputDialog_Alexeev::lastName() const
{
