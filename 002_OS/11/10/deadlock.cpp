...
int main( void ) {
	 ...
	 while( 1 ){
		 WaitForSingleObject(hMutex1, INFINITE);//захват//WaitForSingleObject Waits until the specified object is in the signaled state or the time-out interval elapses.
		 printf("%g\n",sh1);
