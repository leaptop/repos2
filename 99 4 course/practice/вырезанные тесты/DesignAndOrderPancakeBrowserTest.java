...
public class DesignAndOrderPancakeBrowserTest {
...
/*repo.save(new Ingredient("EGGS", "С яйцами", Type.WRAP));//в методе run сразу создаём список ингредиентов
  ...
  public void testDesignAPancakePage_HappyPath() throws Exception {
    ...
    buildAndSubmitAPancake("Basic Pancake", "EGGS", "CHCK", "CHED", "TMTO", "BSHM");
    clickBuildAnotherPancake();
    buildAndSubmitAPancake("Another Pancake", "VEGG", "BEEF", "GAUD", "GREN", "SRCR");
  ...
  public void testDesignAPancakePage_InvalidOrderInfo() throws Exception {
    ...
    assertDesignPageElements();
    buildAndSubmitAPancake("Basic Pancake", "FLTO", "GRBF", "CHED", "TMTO", "SLSA");
  ...
  private void buildAndSubmitAPancake(String name, String... ingredients) {
    ...
    browser.findElementByCssSelector("form#pancakeForm").submit();
  }
