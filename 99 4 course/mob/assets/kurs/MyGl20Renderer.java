...
public class MyGl20Renderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        Bottle = new Objects(c, new float[]{0.4f, 0.2f, 0.3f, 1.0f}, "bottle.obj");
        Title = new Objects(c, new float[]{0f, 0f, 0f, 1.0f}, "Title.obj");
        Stakan = new Objects(c, new float[]{0.4f, 0.4f, 0.4f, 1.0f}, "Stakan.obj");

        mSpace = new Space();

        mSimpleShadowProgram = new MyRender(R.raw.vertex_shadow, R.raw.fragment3_shader, mShadowsActivity);
        mDepthMapProgram = new MyRender(R.raw.fragment2_shader, R.raw.fragment_shader, mShadowsActivity);
    ...
    private void renderScene() {
        ...
        Bottle.render(scene_positionAttribute, scene_normalAttribute, scene_colorAttribute,  false);
        ...
        Apple.render(scene_positionAttribute, scene_normalAttribute, scene_colorAttribute,  false);
        Stakan.render(scene_positionAttribute, scene_normalAttribute, scene_colorAttribute,  false);

        mSpace.render(scene_positionAttribute, scene_normalAttribute, scene_colorAttribute, false);
    }
}
