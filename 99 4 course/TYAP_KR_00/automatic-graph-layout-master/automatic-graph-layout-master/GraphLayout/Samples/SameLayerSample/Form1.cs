    ...
    public partial class Form1 : Form {
        ...
        public void buildDFASuffPref() {
            ...
            if (finalSubstring.Length == 0 && multiplicity == 1) {//                            I
                ...
                list = new List<Node>();//Создал список состояний, в которых буду хранить суффиксы, префиксы и другое в удобном для меня виде
                    ...
                    for (int j = 0; j < alphabet.Length; j++) {
                        for (int k = fullPrefix.Length - 1 + 1; k >= 0; k--) {
                            ...
                            if (currentPrefix.Equals(currentSuffix)) {
                                ...
                                if (k == 0 && !foundEqualSuffAndPref && !(alphabet[j].Equals(symbolForMultiplicity))) {                                                                                             //Здесь косяк. 
