...
//это не канает для нашего задания. Нам надо возможность брать один предмет несколько раз
    ...
    public static void main(String[] args) {
        ...
        int n = weight.length;//длина массива
        int W = 11;//максимальный вес, который можно набрать
        System.out.println(" Максимальная стоимость: " +
                ob.knapsackRec(weight, value, n, W));//вес, цена, длина массива весов/цен
