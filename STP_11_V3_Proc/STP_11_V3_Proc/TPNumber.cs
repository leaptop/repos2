...
namespace STP_11_V3_Proc
{
    public class TPNumber : ICloneable, InterfaceForNumbers<TPNumber>
    {
        ...
        public TPNumber sqr0()
        {
            return new TPNumber(nDecimal * nDecimal, b, c);
        }
        public TPNumber sqr(TPNumber tp)
        {
            return new TPNumber(tp.nDecimal * tp.nDecimal, tp.b, tp.c);
        }
        ...
        public TPNumber mul(TPNumber a, TPNumber b)
        {
            throw new NotImplementedException();
        }

        public TPNumber sub(TPNumber a, TPNumber b)
        {
            throw new NotImplementedException();
        }

        public TPNumber dvd(TPNumber a, TPNumber b)
        {
            throw new NotImplementedException();
        }

        public TPNumber none(TPNumber a, TPNumber b)
        {
            throw new NotImplementedException();
        }

        public TPNumber rev(TPNumber a)
        {
            throw new NotImplementedException();
        }
    }
