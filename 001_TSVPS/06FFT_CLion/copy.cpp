...
void FFT(complex<double> *array, complex<double> *a_0) {
    ...
    complex<double> rotate_multiplier = exp(complex<double>(0, (-2 * M_PI) / n));//z - complex, r - real, i - image
...
int main() {
    ...
    cout << fixed << endl << endl << "Operations num:" << count / 2 << endl;
