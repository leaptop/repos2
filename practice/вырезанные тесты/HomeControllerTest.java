...
import pancake.web.OrderProps;
import pancake.data.IngredientRepository;
import pancake.data.OrderRepository;
...
public class HomeControllerTest {
  ...
  /*Большая часть этих MockBean здесь для того, чтобы избежать проблем с автосвязыванием.
   * Они на самом деле ничего не тестируют. Они нужны просто для того, чтобы автосвязывание сработало
   * */
  @MockBean
